...
public class Badge extends TextView {
     ...
     */
	public Badge(Context context, View target) {
     ...
     */
	public Badge(Context context, TabWidget target, int index) {
	...
	public Badge(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
