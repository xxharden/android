...
public class PullToRefreshView extends LinearLayout {
	 ...
	 * 赞总页数
	 */
	private int zanpageSize = 1;

	public int getZanpageSize() {
		return zanpageSize;
	}

	public void setZanpageSize(int zanpageSize) {
		this.zanpageSize = zanpageSize;
	}
	...
	public void setFooterViewVisibile() {
		if (currPage < pageSize) {
			mFooterView.setVisibility(View.VISIBLE);
		} else {
			mFooterView.setVisibility(View.GONE);
