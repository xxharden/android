...
public class DBHelper extends SQLiteOpenHelper {
	...
	private static String DB_PATH = "/data/data/com.example.wgj.shangcheng/databases/";
	/*
	...
	public void createDataBase() throws IOException {
		...
		if (dbExist) {
			...
			try {
				...
				if (!dir.exists()) {
					dir.mkdirs();
					MyLog.i("wg", "创建 文件夹···" + DB_PATH);
				}
				File dbf = new File(DB_PATH+DB_NAME);
				if (!dbf.exists()) {
					dbf.delete();
//					dbf.mkdirs();
					MyLog.i("wg", "创建 文件夹···" + DB_PATH + DB_NAME);
				}
