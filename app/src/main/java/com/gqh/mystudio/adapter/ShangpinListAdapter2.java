...
import com.gqh.mystudio.activity.QiaoSongLiActivity;
 ...
 * desc:
 */
public class ShangpinListAdapter2 extends BaseAdapter {
    ...
    public ShangpinListAdapter2(List<ShangpinListEntity> mList, Context context) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.iv_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((QiaoSongLiActivity)context).addPic(entity);
            }
        });
        return convertView;
    }
