 ...
 * desc:
 */
public class GrideviewAdapter extends MyBaseAdapter<String> {
    ...
    public GrideviewAdapter(List<String> mList, Context context, int style) {//Constant.STYLE_ADAPTER_OK显示全部
        super(mList, context);
...
//				.displayer(new RoundedBitmapDisplayer(20))  // 设置成圆角图片
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView iv = null;
        if (convertView==null){
            convertView =mInflater.inflate(R.layout.item_gridview_photo_3_1, null) ;
