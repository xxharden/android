 ...
 * desc:
 */
public class AdapterFuwuJilu_listView extends MyBaseAdapter<FuwuEntity> {

    private HoldView holdView;
    private List<FuwuEntity> mList;
    private Context context;
    public AdapterFuwuJilu_listView(List<FuwuEntity> mList, Context context) {
        super(mList, context);
        this.mList=mList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_listview_fuwu_jilu, null);

            holdView.iv_tupian= (ImageView) convertView.findViewById(R.id.baojie_photo);
            holdView.iv_jiantou= (ImageView) convertView.findViewById(R.id.iv_jiantou_baojie);
            ...
            holdView.bt_pingjia= (Button) convertView.findViewById(R.id.bt_pingjia_baojie);
        ...
        if(!StringUtil.isEmpty(fuwuEntity.getOrderType())){
            ...
            MyLog.i("type=",fuwuEntity.getOrderType());
